...
4. Add a `SEARCHAPI_API_KEY` Actions secret under **Settings → Secrets and variables → Actions** to enable automatic Google Scholar refreshes from hosted runners. `SERPAPI_API_KEY` remains supported as an optional second provider.
